...
<div class="btn-toolbar" role="toolbar">
    <div class="btn-group btn-group-lg">
        <button type="button" class="btn btn-default" onclick="location.href='?seq=Admin_UserMng_AddEntry'">&lt;&nbsp;入力画面へ戻る</button>
    </div>
    <div class="btn-group btn-group-lg pull-right">
        <button type="button" class="btn btn-default" onclick="location.href='?seq=Admin_UserMng_AddComplete'">この内容で登録する&nbsp;&gt;</button>
    </div>
</div>
