...
<div class="btn-toolbar" role="toolbar">
    <div class="btn-group btn-group-lg pull-right">
        <button type="button" class="btn btn-default" onclick="location.href='?seq=Admin_UserMng_AddEntry'">新規ユーザ追加
        </button>
    </div>
</div>
                        ...
                        <div class="btn-toolbar" role="toolbar">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default btn-sm"
                                        onclick="location.href='?seq=Admin_UserMng_ModPreload.{$dat.no}'">変更
                                </button>
                            </div>
                            {if $dat.no != '1'}
                                <div class="btn-group pull-right">
                                    <button type="button" class="btn btn-danger btn-sm"
                                            onclick="location.href='?seq=Admin_UserMng_DelConfirm.{$dat.no}'">削除
                                    </button>
                                </div>
                            {/if}
                        </div>
