...
<div class="col-sm-4">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <ul>
                <li><a href="http://blog.hyec.jp/search/label/Risoluto" target="_blank">Yuta Hayakawa(Project
                        Manager)</a></li>
            </ul>
        </div>
            ...
            <dl>
                ...
                <dd>
                    <a href="http://www.jetbrains.com/phpstorm/"
                       style="display:block; background:#5854b5 url(http://www.jetbrains.com/phpstorm/documentation/phpstorm_banners/phpstorm1/phpstorm234x60_violet.gif) no-repeat 0 0; border:solid 1px #5854b5; margin:0;padding:0;text-decoration:none;text-indent:0;letter-spacing:-0.001em; width:252px; height:58px"
                       alt="Smart IDE for PHP development with HTML, CSS &amp; JavaScript support"
                       title="Smart IDE for PHP development with HTML, CSS &amp; JavaScript support"
                       target="_blank"><span
                                style="margin: 0px 0 0 59px;padding: 0;float: left;font-size: 10px;cursor:pointer;  background-image:none;border:0;color: #fff; font-family: trebuchet ms,arial,sans-serif;font-weight: normal;text-align:left;">Developed with</span><span
                                style="margin:36px 0 0 7px;padding:0 0 2px 0; line-height:10px;font-size:11px;cursor:pointer;  background-image:none;border:0;display:block;width:240px; color:#fff; font-family:trebuchet ms,arial,sans-serif;font-weight: normal;text-align:left;">Smart IDE for PHP development with HTML, CSS &amp; JavaScript support</span></a><br/>
                </dd>
                ...
                <dd>
                    <div style="width:150px; height:80px; margin:0; padding:0;"><a
                                href="http://www.cloudcore.jp/vps/?utm_source=ad&utm_medium=ad&utm_content=dev&utm_campaign=vps"
                                target="_blank" rel="nofollow"><img
                                    src="http://www.cloudcore.jp/vps/develop/links/images/150x80_white.gif"
                                    alt="CloudCore" style="border:0; margin-bottom:4px;"/></a></div>
                </dd>
            </dl>
        </div>
    </div>
    ...
    {literal}
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <a class="twitter-timeline" href="https://twitter.com/risoluto_dev" data-widget-id="406385397602582528">@risoluto_dev
                    からのツイート</a>
...
290&colorscheme=light&show_faces=true&border_color&stream=false&header=true&appId=187417324641052" scrolling="no"
